...
* In Github, fork `https://github.com/mantikafasi/gowsdl` to your own account
* Get the package using "go get": `go get github.com/mantikafasi/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/mantikafasi/gowsdl/`
